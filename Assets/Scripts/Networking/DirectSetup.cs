...
public class DirectSetup : MonoBehaviour
{
    ...
    protected bool m_MatchCreated;
    protected bool m_MatchJoined;
    protected MatchInfo m_MatchInfo;
    protected string m_MatchName = "NewRoom";
    protected NetworkMatch m_NetworkMatch;

    // Connection/communication related
    protected int m_HostId = -1;
    // On the server there will be multiple connections, on the client this will only contain one ID
    protected List<int> m_ConnectionIds = new List<int>();
    protected byte[] m_ReceiveBuffer;
    protected string m_NetworkMessage = "Hello world";
    protected string m_LastReceivedMessage = "";
    protected NetworkWriter m_Writer;
    protected NetworkReader m_Reader;
    protected bool m_ConnectionEstablished;

    protected const int k_ServerPort = 25000;
    protected const int k_MaxMessageSize = 65535;
    ...
    virtual protected void StartServer(string relayIp, int relayPort, NetworkID networkId, NodeID nodeId)
    {
        SetupHost(true);
    ...
    protected void ConnectThroughRelay(string relayIp, int relayPort, NetworkID networkId, NodeID nodeId)
    {
        SetupHost(false);
